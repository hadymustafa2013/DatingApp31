...
namespace DatingApp31.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        public async Task<IActionResult> getMessageThread(int userId, int recepientId)
        {
            ...
            var messageFromRep = await _repo.GetMessageThread(userId, recepientId);

            var messageThread = _mapper.Map<IEnumerable<MessageToReturnDto>>(messageFromRep);
        ...
        public async Task<IActionResult> CreateMessage(int userId, MessageForCreationDto messageForCreationDto)
        {
            ...
            throw new Exception("Creatimg message failed on save");
        }
